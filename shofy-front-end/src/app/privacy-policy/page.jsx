  ...
  return (
    <Wrapper>
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <section className="mb-6">
          <h6 className="text-l font-semibold mb-2">How We Use Information</h6>
          <p>
        ...
        <section className="mb-6">
          <h6 className="text-xl font-semibold mb-2"> Sharing of Information</h6>
          <p>
        ...
        <section className="mb-6">
          <h6 className="text-xl font-weight:400 mb-2"> Data Security</h6>
          <p>
        ...
        <section className="mb-6">
          <h6 className="text-xl font-weight:400 mb-2"> Your Rights</h6>
          <p>
            You may request access, correction, or deletion of your data at any
            time. Contact us at{" "}
            <a href="mailto:support@lookfamef.com" className="text-[#F875AA] underline font-bold">
        ...
        <section className="mb-6">
          <h6 className="text-xl font-weight:400 mb-2"> Cookies & Tracking</h6>
          <p>
        ...
        <section className="mb-6">
          <h6 className="text-xl font-weight:400 mb-2"> Third-Party Services</h6>
          <p>
        ...
        <section className="mb-6">
          <h6 className="text-xl font-weight:400 mb-2"> Changes to This Policy</h6>
          <p>
        ...
        <section>
          <h6 className="text-xl font-weight:400 mb-2"> Contact Us</h6>
          <p>
